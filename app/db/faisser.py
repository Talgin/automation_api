...
class Faisser:
    ...
    def save_faiss_index(self, path_to_save):
        """Saving modified faiss index in the given location
    ...
    def create_block_and_index(self, new_vectors, new_ids_np, trained_index_path, path_to_save_new_block, merged_index_path, local_faiss_backup_path):
        ...
        trained_index.add_with_ids(new_vectors, new_ids_np)
